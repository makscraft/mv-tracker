...
if(HttpisPostRequest())
{
    ...
    if($form -> isSubmitted() && $form -> isValid())
    {
        ...
        $task -> date_updated = I18ngetCurrentDateTime();
        $task -> update();
        ...
        $files = MultiImagesModelElementpackValue($data_files);
        ...
        if($task -> assigned_to && $task -> assigned_to != $account -> id && ($notify || $form -> comment || $files))
        {
            ...
            JournalsendEmail($assigned_to, $task, $message, $files);
        ...
        $_SESSION["account"]["message-success"] = I18nlocale("task-updated");
...
?>
    <div id="content">
        <h1><?php echo I18nlocale("edit-task"); ?></h1>
        ...
        <form class="regular" enctype="multipart/form-data" method="post" action="<?php echo $action_form; ?>">
               ...
               <div class="single">
                  <div class="field-name">
                     <?php echo I18nlocale("description"); ?>                     
                     <span id="edit-description"><?php echo I18nlocale("edit"); ?></span>
                  </div>
