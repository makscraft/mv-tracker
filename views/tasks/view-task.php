...
$date_due_value = ($task -> date_due && $task -> date_due != "0000-00-00") ? I18nformatDate($task -> date_due) : "-";
...
<div id="content" class="task-content">
    <div class="wrapper-left clearfix">
        ...
        <div class="item-actions task-actions">
            <a class="create" href="<?php echo $mv -> root_path; ?>task/edit/<?php echo $task -> id; ?>"><?php echo I18nlocale("edit"); ?></a>
            <span class="delete<?php echo $can_delete ? "" : " off"; ?>" id="delete-task-<?php echo $task -> id."-".$token_delete; ?>"><?php echo I18nlocale("delete"); ?></span>
        </div>        
        <div class="clear"></div>
        <div class="task-info">
           ...
           <span><?php echo TasksprocessDateTimeValue($task -> date_created); ?></span>
        </div>        
        ...
        <?php if($task -> files): ?>
            <div class="task-files">
                <h3><?php echo I18nlocale("attached-files"); ?></h3>
        ...
        <div class="button green big add-comment" id="comment-task-<?php echo $task -> id."-".$token_comment; ?>">
            <?php echo I18nlocale("add-comment"); ?>
        </div>
        <?php if($html = $mv -> journal -> displayTaskHistory($task, $account)): ?>
            <div class="task-history">
                <h2><?php echo I18nlocale("task-comments"); ?></h2>
                <?php echo $html; ?>
            </div>
        <?php
        	endif;
        ...
        <div class="form-buttons clearfix">
            <a class="back" href="<?php echo $to_project; ?>"><?php echo $task -> getEnumTitle("project"); ?></a>
            <a id="back-button" class="button green medium" href="<?php echo $back_url; ?>"><?php echo I18nlocale("back"); ?></a>
        </div>
    </div>
    <div class="task-params">
        <table>
            ...
            <tr>
                <td class="second"><?php echo I18nlocale("project"); ?>:</td>
                <td><?php echo $task -> getEnumTitle("project"); ?></td>
            </tr>
            <tr>
                <td class="second"><?php echo I18nlocale("tracker"); ?>:</td>
                <td><?php echo $task -> getEnumTitle("tracker"); ?></td>
            </tr>
            <tr>
                <td class="second"><?php echo I18nlocale("date-due"); ?>:</td>
                <td><?php echo $date_due_value; ?></td>
            </tr>
            <tr>
                <td><?php echo I18nlocale("assigned-to"); ?>:</td>
                <td><?php echo $task -> assigned_to ? $task -> getEnumTitle("assigned_to") : "-"; ?></td>
            </tr>
            <tr>
                <td class="second"><?php echo I18nlocale("priority"); ?>:</td>
            ...
            <tr>
                <td><?php echo I18nlocale("status"); ?>:</td>
                <td><?php echo $task -> getEnumTitle("status"); ?></td>
            </tr>
            <tr>
                <td><?php echo I18nlocale("implementation"); ?>:</td>
                <td><?php echo $complete_value; ?></td>
            </tr>
            <tr>
                <td><?php echo I18nlocale("hours-estimated"); ?>:</td>
                <td><?php echo $task -> hours_estimated ? $task -> hours_estimated : "-"; ?></td>
            </tr>
            <tr>
                <td class="second"><?php echo I18nlocale("hours-spent"); ?>:</td>
