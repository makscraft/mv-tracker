...
$params = array("status->in" => $open, "project->in" => $projects);
$base_url = $_SESSION["last-page"] = "tasks";
...
?>
    <div id="content" class="tasks-page">
        ...
        <div class="top-buttons clearfix">
            <a class="button grey big tab" href="<?php echo $mv -> root_path; ?>home"><?php echo I18n :: locale("my-tasks"); ?></a>
            <a class="button grey big tab active" href="<?php echo $mv -> root_path; ?>tasks"><?php echo I18n :: locale("all-tasks"); ?></a>
        ...
        <form action="<?php echo $mv -> root_path; ?>tasks" method="post" id="items-table-form">
