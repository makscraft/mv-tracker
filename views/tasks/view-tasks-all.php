...
?>
    <div id="content" class="tasks-page">
        ...
        <div class="top-buttons clearfix">
            <a class="button grey big tab" href="<? echo $mv -> root_path; ?>home"><? echo I18n :: locale("my-tasks"); ?></a>
            <a class="button grey big tab active" href="<? echo $mv -> root_path; ?>tasks"><? echo I18n :: locale("all-tasks"); ?></a>
        ...
        <form action="<? echo $mv -> root_path; ?>tasks" method="post" id="items-table-form">
