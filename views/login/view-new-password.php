...
$form -> setHtmlParams("password", 'placeholder="'.I18nlocale("new-password").'"');
$form -> setHtmlParams("password_repeat", 'placeholder="'.I18nlocale("password-repeat").'"');
         ...
         <h1><?php echo I18nlocale("password-restore"); ?></h1>
            ...
            <form class="regular" method="post" action="<?php echo $mv -> root_path; ?>recovery/create">
               ...
               <div class="form-buttons clearfix">
                   ...
                   <input type="submit" value="<?php echo I18nlocale("save"); ?>" class="button big"/>
               </div>
               <div class="clear"></div>
            </form>
      </div>
